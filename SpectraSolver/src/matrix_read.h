...
using vecint = Eigen::Matrix<int, Eigen::Dynamic, 1>;
    ...
    using matcd =
        ...
        basic_couple(matcd& a0, matcd& a1, matcd& a2){};
...
class couplematrix {
   public:
    ...
    // constructor if reading in normal mode coupling matrices, receiver and source vectors etc from binary files that go into the old code
